$(document).ready(function() {
    ...
    function displayQuestions(page) {
      ...
      $.get(url, function(data) {
        ...
        $("#java-questions-container").empty();
    ...
    function displayQuestionElement(index, question) {
      ...
      $("#java-questions-container").append(questionElement);
      ...
      if (question.type === "true-false") {
        ...
        $("#java-questions-container").append(trueLabel, trueRadioBtn, falseLabel, falseRadioBtn, lineBreak, lineBreak2);
      }
    }
    ...
    function updatePagination(currentPage) {
      ...
      $("#java-pagination-container").empty();
    ...
    function createPaginationButton(page, currentPage) {
      ...
      $("#java-pagination-container").append(button);
    }
    ...
    function calculateGrade() {      
      for (var i = startingIndex; i < 22; i++) {
        var question = questions[i];
    ...
    $("#java-submit-btn").click(handleSubmitButtonClick);
  });  
